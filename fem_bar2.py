...
def bar3(num_elems):
	...
	k = np.array([[7,-8,1],[-8,16,-8],[1,-8,7]]) * (num_elems/3.0) 
	...
	for i in range(num_elems):
		...
		first_node = 2*i 
		M_temp[first_node:first_node+3, first_node:first_node+3] = m  #  3x3
		K_temp[first_node:first_node+3, first_node:first_node+3] = k  #  3x3
		M += M_temp
		K += K_temp
